...
public class TramuaSubListAdapter extends BaseAdapter {

	private LayoutInflater mInflater;
	private List<OrdernIdicatorEntry> items = new ArrayList<OrdernIdicatorEntry>();
	...
	public TramuaSubListAdapter(Context context, ArrayList<OrdernIdicatorEntry> items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		OrdernIdicatorEntry item = items.get(position);
